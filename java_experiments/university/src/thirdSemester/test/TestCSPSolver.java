...
import thirdSemester.csp.CSPSolver;
import thirdSemester.csp.Graph;
import static org.junit.jupiter.api.Assertions.*;

public class  TestCSPSolver {

    /**
     * Tests a simple linear graph to verify if the solver calculates the shortest path correctly.
     * Expected: The minimal path cost from node 0 to node 2 should be 5.
     */
    @Test
    public void testSimpleGraph() {
        ...
        int maxResource = 5;
        CSPSolver solver = new CSPSolver(graph, maxResource);
